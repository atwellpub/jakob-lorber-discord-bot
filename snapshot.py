...
IGNORE_PATTERNS = [".log" ,"assets","readme","snapshot","index.php","package", ".idea","node_modules",".git","pycache","captures","requirements", "yarn", "webpack", "eslintrc",".next","package-lock","config.example.json"]
FOCUS_PATTERNS = []
